...
public class Player : MonoBehaviour
{
    ...
    private void Shoot()
    {
        // added the timescale condition so laser wont instantiate if game is paused but depend on unity variable
        if (Input.GetKeyDown(KeyCode.Space) && Time.time > next_fire && Time.timeScale != 0)
        {
